...
public class JSONMain {	
	...
	public static String place (String ipaddr) throws IOException{
		...
		return pls;
	}	//public static String place (String ipaddr)
	
	
	public static String strtostr(String q){		//	выделение числа из строки       
	       String result = "";
   ...
   for (int i = 0; i < numbers.length; i++)
	...
	public static String rate (String urrl) throws IOException {	//	какой обменный курс?	begin
		String cost = "";
